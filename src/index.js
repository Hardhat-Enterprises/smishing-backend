...
import adminSecurityRoute from "./routes/adminSecurity.route.js"; // Admin Security Dashboard API
...
app.use("/api/admin", adminSecurityRoute); // my second addition for the Admin Security Dashboard API
