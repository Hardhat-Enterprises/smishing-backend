...
import detectionsRoute from "./routes/detections.route.js"; // Added by Niyati - detections route
...
app.use("/api/detections", detectionsRoute); // Added by Niyati - detections retrieval endpoint
